...
<!-- BEGIN:STAMP -->
_最后更新：**2026-05-28 05:52 UTC**  ·  数据源：FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:TREND_PANEL -->
**流动性流向分数: `+3/5` — **偏向流动性放水****
  · 4 个变量指向放水, 1 个紧缩, 0 中性

| 变量 | 方向 | 当前值 | 上次拐点 | 趋势年龄 | 含义 |
|---|:-:|---:|:-:|---:|:-:|
| 美联储资产负债表 | ↑ 上行 | 6.717 | 2026-03 | 2.0m | 🟢 放水 |
| Net Liquidity (Fed BS − TGA − RRP) | ↑ 上行 | 5.881 | 2026-05 | 0.0m | 🟢 放水 |
| M2 货币供应量 | ↑ 上行 | 22,804 | 2024-02 | 26.0m | 🟢 放水 |
| 10年期国债收益率 | ↑ 上行 | 4.488 | 2026-04 | 1.0m | 🔴 紧缩 |
| 美元指数 DXY | ↓ 下行 | 99.429 | 2025-03 | 14.0m | 🟢 放水 |
<!-- END:TREND_PANEL -->
