...
<!-- BEGIN:STAMP -->
_Last updated: **2026-07-23 23:02 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.285`  ·  Composite percentile: `77%`  ·  Zone: **HIGH** (**~ MID**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 34.850 | 2023-10 | 33.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | 3.423 | 2025-04 | 15.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| SOX vs SPX 3m RS | 14.358 | 89% | HIGH [BULL] | MOSTLY | +4.2pp |
| Market cap / M2 (Buffett indicator variant) | 3.282 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| NDX vs SPX 3m RS | 0.864 | 44% | MID [mid] | — | — |
| Russell 2000 vs SPX 3m RS | 2.184 | 68% | MID [mid] | — | — |
| 10Y Treasury 3m change | 24.291 | 70% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
