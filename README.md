...
<!-- BEGIN:STAMP -->
_Last updated: **2026-07-29 23:03 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.645`  ·  Composite percentile: `99%`  ·  Zone: **EXTREME_HIGH** (**↑ TOP-LEANING**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 37.018 | 2023-10 | 33.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | 2.775 | 2025-04 | 15.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| NDX vs SPX 3m RS | -2.397 | 24% | MID [mid] | — | — |
| SOX vs SPX 3m RS | -1.992 | 33% | MID [mid] | — | — |
| Russell 2000 vs SPX 3m RS | 2.280 | 69% | MID [mid] | — | — |
| 10Y Treasury 3m change | 26.459 | 72% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
