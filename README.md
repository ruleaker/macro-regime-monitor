...
<!-- BEGIN:STAMP -->
_Last updated: **2026-08-05 23:06 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.748`  ·  Composite percentile: `100%`  ·  Zone: **EXTREME_HIGH** (**↑ TOP-LEANING**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 53.921 | 2023-10 | 34.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | 0.789 | 2025-04 | 16.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| SOX vs SPX 3m RS | -8.134 | 17% | LOW [BEAR] | MOSTLY | -5.5pp |
| NDX vs SPX 3m RS | -4.593 | 14% | LOW [BEAR] | REGIME-DEP | -8.3pp |
| Market cap / M2 (Buffett indicator variant) | 3.252 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| Russell 2000 vs SPX 3m RS | 1.499 | 64% | MID [mid] | — | — |
| 10Y Treasury 3m change | 18.100 | 66% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
