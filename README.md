...
<!-- BEGIN:STAMP -->
_Last updated: **2026-06-16 23:28 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.017`  ·  Composite percentile: `40%`  ·  Zone: **MID** (**~ MID**)
...
| Net Liquidity (NETLIQ) | ↓ DOWN | 5.865 | 2024-09 | 21.0m | 🔴 TIGHTEN |
| M2 12-month growth (M2_GROWTH) | ↑ UP | 4.327 | 2024-08 | 19.9m | 🟢 RELEASE |
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 35.500 | 2023-10 | 32.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | -0.420 | 2025-04 | 14.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| NDX vs SPX 3m RS | 9.717 | 92% | HIGH [BULL] | MOSTLY | +4.8pp |
| SOX vs SPX 3m RS | 52.272 | 99% | HIGH [BULL] | MOSTLY | +4.2pp |
| Market cap / M2 (Buffett indicator variant) | 3.160 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| Russell 2000 vs SPX 3m RS | 2.333 | 70% | MID [mid] | — | — |
| 10Y Treasury 3m change | 25.227 | 71% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
