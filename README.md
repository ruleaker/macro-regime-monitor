...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.539`  ·  Composite percentile: `96%`  ·  Zone: **EXTREME_HIGH** (**↑ TOP-LEANING**)
...
| SOX vs SPX 3m RS | -13.879 | 9% | LOW [BEAR] | MOSTLY | -5.5pp |
| Russell 2000 vs SPX 3m RS | -9.134 | 3% | LOW [BULL] | REGIME-DEP | +5.9pp |
| 10Y Treasury 3m change | 45.952 | 85% | HIGH [BEAR] | REGIME-DEP | +0.9pp |
| Market cap / M2 (Buffett indicator variant) | 3.301 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| NDX vs SPX 3m RS | -2.090 | 26% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
