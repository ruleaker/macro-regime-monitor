...
<!-- BEGIN:STAMP -->
_Last updated: **2026-09-16 00:05 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->

## Current state

<!-- BEGIN:HEADLINE -->
**Net 12-month historical effect from currently-triggered signals: `-20.2pp` — leans BEARISH.**
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.642`  ·  Composite percentile: `99%`  ·  Zone: **EXTREME_HIGH** (**↑ TOP-LEANING**)
...
|---|:-:|---:|:-:|---:|:-:|
| Fed Balance Sheet (WALCL) | ↑ UP | 6.739 | 2026-04 | 5.0m | 🟢 RELEASE |
| Net Liquidity (NETLIQ) | ↓ DOWN | 5.812 | 2024-09 | 24.0m | 🔴 TIGHTEN |
| M2 12-month growth (M2_GROWTH) | ↑ UP | 4.947 | 2024-08 | 23.0m | 🟢 RELEASE |
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 60.298 | 2023-10 | 35.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | -1.507 | 2025-04 | 17.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
|---|---:|---:|:-:|:-:|---:|
| Margin debt / M2 | 0.061 | 99% | HIGH [BEAR] | DURABLE | -13.2pp |
| SOX vs SPX 3m RS | -22.452 | 5% | LOW [BEAR] | MOSTLY | -5.5pp |
| NDX vs SPX 3m RS | -5.509 | 12% | LOW [BEAR] | REGIME-DEP | -8.3pp |
| Russell 2000 vs SPX 3m RS | -6.175 | 10% | LOW [BULL] | REGIME-DEP | +5.9pp |
| 10Y Treasury 3m change | 37.841 | 81% | HIGH [BEAR] | REGIME-DEP | +0.9pp |
| Market cap / M2 (Buffett indicator variant) | 3.224 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
<!-- END:SIGNAL_TABLE -->
