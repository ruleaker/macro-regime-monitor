...
<!-- BEGIN:STAMP -->
_Last updated: **2026-07-26 23:03 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.365`  ·  Composite percentile: `87%`  ·  Zone: **HIGH** (**~ MID**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 35.775 | 2023-10 | 33.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | 3.289 | 2025-04 | 15.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| NDX vs SPX 3m RS | -0.343 | 34% | MID [mid] | — | — |
| SOX vs SPX 3m RS | 9.440 | 79% | MID [mid] | — | — |
| Russell 2000 vs SPX 3m RS | 1.781 | 65% | MID [mid] | — | — |
| 10Y Treasury 3m change | 25.216 | 71% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
