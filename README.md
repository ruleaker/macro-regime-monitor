...
<!-- BEGIN:STAMP -->
_Last updated: **2026-06-01 23:40 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `-0.040`  ·  Composite percentile: `33%`  ·  Zone: **MID** (**~ MID**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 39.011 | 2023-10 | 31.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | -0.779 | 2025-04 | 14.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| NDX vs SPX 3m RS | 10.412 | 93% | HIGH [BULL] | MOSTLY | +4.8pp |
| SOX vs SPX 3m RS | 46.777 | 99% | HIGH [BULL] | MOSTLY | +4.2pp |
| Market cap / M2 (Buffett indicator variant) | 3.160 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| Russell 2000 vs SPX 3m RS | -0.010 | 52% | MID [mid] | — | — |
| 10Y Treasury 3m change | 35.821 | 80% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
