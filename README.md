...
<!-- BEGIN:STAMP -->
_Last updated: **2026-06-29 23:04 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.076`  ·  Composite percentile: `47%`  ·  Zone: **MID** (**~ MID**)
...
| 10Y Yield 6m change (DGS10_6M_CHG) | ↑ UP | 33.366 | 2023-10 | 32.0m | 🔴 TIGHTEN |
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | 1.151 | 2025-04 | 14.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| NDX vs SPX 3m RS | 10.048 | 92% | HIGH [BULL] | MOSTLY | +4.8pp |
| SOX vs SPX 3m RS | 58.527 | 99% | HIGH [BULL] | MOSTLY | +4.2pp |
| Russell 2000 vs SPX 3m RS | 5.812 | 88% | HIGH [BEAR] | REGIME-DEP | -5.1pp |
| Market cap / M2 (Buffett indicator variant) | 3.282 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| 10Y Treasury 3m change | 23.093 | 70% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
