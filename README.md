...
<!-- BEGIN:STAMP -->
_Last updated: **2026-09-08 00:07 UTC**  ·  Data: FRED · Yahoo Finance · FINRA_
<!-- END:STAMP -->
...
<!-- BEGIN:COMPOSITE -->
Composite value: `+0.661`  ·  Composite percentile: `99%`  ·  Zone: **EXTREME_HIGH** (**↑ TOP-LEANING**)
...
| DXY 3-month % change (DXY_3M_CHG) | ↓ DOWN | -1.990 | 2025-04 | 17.0m | 🟢 RELEASE |
<!-- END:TREND_PANEL -->
...
| SOX vs SPX 3m RS | -19.969 | 5% | LOW [BEAR] | MOSTLY | -5.5pp |
| NDX vs SPX 3m RS | -5.190 | 12% | LOW [BEAR] | REGIME-DEP | -8.3pp |
| Russell 2000 vs SPX 3m RS | -4.406 | 18% | LOW [BULL] | REGIME-DEP | +5.9pp |
| Market cap / M2 (Buffett indicator variant) | 3.224 | 100% | HIGH [BEAR] | TOMBSTONE | *failed stability test* |
| 10Y Treasury 3m change | 31.286 | 76% | MID [mid] | — | — |
<!-- END:SIGNAL_TABLE -->
